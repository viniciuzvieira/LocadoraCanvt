...
<head>
    <meta charset="utf-8">
    <!-- TITLE -->
    <title>Blog Detail Full Width</title>
                        ...
                        <ul class="menu">
                            ...
                            <li class="current-menu-item">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="current-menu-item"><a href="blog-detail-fullwidth.html">Blog Detail Fullwidth</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="blog-content">
                                ...
                                <article class="post post-single">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <img src="images/blog/img-2.jpg" alt="" class="aligncenter"><br><br>
                                ...
                                <div class="comment-respond">
                                    ...
                                    <form action="#" method="post" class="comment-form">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <input type="text" class="field-text" placeholder="Name">
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea placeholder="Your comment" class="field-textarea"></textarea>
                                            </div>
                                            <div class="col-sm-12">
